...
const NavMapPage: React.FC<MapProps> = ({ onImageClick }) => {
    ...
    return (
        <div className="flex flex-col relative m-auto max-w-[600px] max-h-screen overflow-y-hidden pt-[100px]">
            <div className="flex justify-center gap-5 items-center z-[9]
            ...
            <div className="flex justify-center gap-5 items-center z-[8] relative bottom-[100px]
            ...
            <div className="flex justify-center gap-5 items-center z-[7] relative bottom-[200px]
                            hover:mt-[75px] hover:mb-[75px] transition-all duration-300">
                <h2>Floor 1</h2>
            ...
            <div className="flex justify-center gap-5 items-center z-[6] relative bottom-[300px]
                            hover:mt-[75px] hover:mb-[75px] transition-all duration-300">
                <h2>Floor L1</h2>
            ...
            <div className="flex justify-center gap-5 items-center z-[5] relative bottom-[400px]
