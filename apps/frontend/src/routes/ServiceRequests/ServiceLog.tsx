      ...
      <Container className={"align-content-center container"}>
        ...
        >
          <TabsList classname-={"align-content-center"}>
            ...
            <TabsTrigger value="Internal Transport Service Request">
              Internal Transport
            </TabsTrigger>
            <TabsTrigger value="External Transport Service Request">
              External Transport
            </TabsTrigger>
