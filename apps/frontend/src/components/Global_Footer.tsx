      ...
      <footer className="flex flex-col flex-grow-1 justify-end w-full py-2">
          ...
          <div className="container flex justify-between">
              ...
              <div className="flex items-center">
                  <Link to="/" className="pl-1 inline-block no-underline text-xs after:content-['|'] after:pl-1">Link 1</Link>
                  <Link to="/" className="pl-1 inline-block no-underline text-xs after:content-['|'] after:pl-1">Link 2</Link>
                  <Link to="/" className="pl-1 inline-block no-underline text-xs after:content-['|'] after:pl-1">Link 3</Link>
