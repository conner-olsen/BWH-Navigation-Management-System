...
export default function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-50">
      <div
        className="navbarStyling relative filter-none z-50 shadow-md bg-blue-600 space-x-12 items-center flex
        justify-between px-4 xl:px-0"
      >
        <Link to="/">
          <img
            src="public/BWH_Logo_Sheild.png"
            className="max-w-[50px] py-1"
            alt="Logo"
          ></img>
        </Link>
        ...
        <Link
          to="/Home"
          className="no-underline p-2 text-white hidden xl:block text-[17px]"
        >
          <img
            src={"public/navbar-icons/navbar_map_icon.png"}
            className={"h-7"}
          />
        ...
        {isAuthenticated && (
          <Link
            to="/DataManager"
            className="no-underline p-2 text-white hidden xl:block text-[17px] flex items-center"
          >
            <img
              src={"public/navbar-icons/navbar_data_manager_icon.png"}
              className={"h-7 ml-8"}
            />
        ...
        >
          <img
            src={"public/navbar-icons/navbar_service_request_icon.png"}
            className={"h-7 ml-11"}
          />
        ...
        {isAuthenticated && (
          ...
          >
            <img
              src={"public/navbar-icons/navbar_servicelog_icon.png"}
              className={"h-7 ml-7"}
            />
        ...
        <Link
          to="/AboutPage"
          className="no-underline p-2 text-white hidden xl:block ml-2 text-[17px]"
        >
          <img
            src={"public/navbar-icons/navbar_about_us_icon.png"}
            className={"h-7 ml-5"}
          />
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <img
                  src={user?.picture}
                  alt={"Profile"}
                  className={"UserProfile rounded-full w-8 h-8"}
                />
              </DropdownMenuTrigger>
      ...
      {mobileMenuOpen && (
        <div
          className={`xl:hidden absolute bg-blue-950 max-w-full w-screen z-50`}
        >
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col items-center">
            ...
            <Link
              ...
              className="text-white hover:text-blue-500 block px-3 py-2 rounded-md text-base font-medium no-underline"
            >
              <div className={"hover:text-blue-500"}>Service Requests</div>
            </Link>
            {isAuthenticated && (
              <>
                <Link
      ...
      {mobileMenuOpen && (
        <div
          id="bg-blur"
          className="h-screen w-screen max-w-full absolute
      ...
      <div
        id="bg-blur"
        className="h-0 w-screen max-w-full absolute
                                        left-0 top-0 backdrop-blur-sm z-40
                                        transition-all duration-500"
      ></div>
    </nav>
