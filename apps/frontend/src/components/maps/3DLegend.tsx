const Legend = () => {
  return (
    <div
      className="bg-background h-[250px] w-[250px] fixed top-[90px] right-[20px] p-4 rounded-md border-2
    ...
    >
      ...
      <div className={"flex items-center justify-between"}>
        <div
          className={
            "w-[20px] h-[20px] rounded-[100%] bg-white border-2 border-black"
          }
        ></div>
      ...
      <div className={"flex items-center justify-between"}>
        <div
          className={
            "w-[20px] h-[20px] rounded-[100%] bg-black border-2 border-white"
          }
        ></div>
      ...
      <div className={"flex items-center justify-between"}>
        <div
          className={
            "w-[20px] h-[20px] rounded-[100%] bg-green-500 border-2 border-foreground"
          }
        ></div>
      ...
      <div className={"flex items-center justify-between"}>
        <div
          className={
            "w-[20px] h-[20px] rounded-[100%] bg-blue-700 border-2 border-foreground"
          }
        ></div>
      ...
      <div className={"flex items-center justify-between"}>
        <div
          className={
            "w-[20px] h-[20px] rounded-[100%] bg-yellow-300 border-2 border-foreground"
          }
        ></div>
